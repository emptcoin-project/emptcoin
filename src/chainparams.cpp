...
public:
    CMainParams() {
        ...
        //vSeeds.emplace_back("dnsseed.emptcointools.com", true);
        //vSeeds.emplace_back("dnsseed.emptcoinpool.org", true);
        ...
        chainTxData = ChainTxData{
            ...
            1649462401, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.emptcointools.com", true);
        vSeeds.emplace_back("seed-b.emptcoin.loshan.co.uk", true);

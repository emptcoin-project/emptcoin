...
#if defined(NDEBUG)
# error "Emptcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Emptcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s EMTC additional fees, %d delta bytes\n",

...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s emptcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  emptcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded emptcoin transaction") + "\n" +
              "  emptcoin-tx [options] -create [commands]   " + _("Create hex-encoded emptcoin transaction") + "\n" +
              "\n";

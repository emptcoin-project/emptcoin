...
const char * const BITCOIN_CONF_FILENAME = "emptcoin.conf";
const char * const BITCOIN_PID_FILENAME = "emptcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Emptcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Emptcoin";
#else
    // Unix
    return pathRet / ".emptcoin";
#endif
#endif
}

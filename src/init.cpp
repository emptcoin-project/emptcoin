...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/emptcoin-project/emptcoin>";
    const std::string URL_WEBSITE = "<https://emptcoin.org>";

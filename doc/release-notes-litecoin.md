Emptcoin Core version *0.15.1* is now available from:

  <https://download.emptcoin.org/emptcoin-0.15.1/>
...
A number of changes to the way Emptcoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 empts per kB (0.00001 EMTC). This is to prepare for dropping the minimum transaction fee to 0.1 empts per kB (0.0001 EMTC) in the next release.
